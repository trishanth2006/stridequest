...
import type { CellId } from '@/features/territory/types'
 ...
 * speed, so capture.ts stays decoupled from the GPS layer.
 *
 ...
 *
 * **Delegated entirely to grid.ts (no direct h3-js usage here):**
