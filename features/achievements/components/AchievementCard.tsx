...
export function AchievementCard({ achievement }: { achievement: Achievement }) {
  ...
  return (
    <Card className={`overflow-hidden border-white/[0.06] shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] bg-white/[0.02] transition-colors duration-200 ${achievement.unlocked ? 'border-emerald-500/20 bg-emerald-500/[0.01]' : ''}`}>
