...
- Name: run\history.spec.ts >> Run History — /run/history (02C-03) >> after completing a workout the history page lists it
- Location: tests\e2e\run\history.spec.ts:22:7
